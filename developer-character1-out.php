...
<body>
    ...
    <main>
        ...
        <?php
            ...
            $sql=$pdo->prepare('update hh set chara_name =?, chara_attribute =?, kate_id =?, chara_img =? where chara_id =?');
                if($sql->execute([htmlspecialchars($_POST['chara_name']),$_POST['chara_attribute'],$_POST['kate_id'],$_POST['chara_img'],$_POST['chara_id']])){
                    echo '更新に成功しました。';
                }else{
                    echo '更新に失敗しました。';
                }
    ...
    ?>
        ...
        <p>
        <form action="developer-character1.php" method="post">
